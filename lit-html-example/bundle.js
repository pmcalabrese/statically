...
var lit_html_1 = __webpack_require__(1);
// This is a lit-html template function. It returns a lit-html template.
var helloTemplate = function (name) { return lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<div>Hello ", "!</div>"], ["<div>Hello ", "!</div>"])), name); };
// Call the function with some data, and pass the result to render()
// This renders <div>Hello Steve!</div> to the document body
lit_html_1.render(helloTemplate('Steve'), document.body);
// This updates to <div>Hello Kevin!</div>, but only updates the ${name} part
lit_html_1.render(helloTemplate('Kevin'), document.body);
